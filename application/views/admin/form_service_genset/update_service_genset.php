                        ...
                        <div class="card-body">
                            ...
                            <form action="<?= base_url('admin/proses_update_service_genset'); ?>" method="post" role="form">
                                <?php foreach ($list_data as $ld) { ?>
                                    ...
                                    <div class="form-group">
                                        <label for="pemakai" class="form-label">Nama Pemakai</label>&nbsp;<span style="color: red;"><small>*Pilih nama pemakai terakhir</small></span>
                                        <select name="id_pemakai" class="form-control" id="id_pemakai" required>
                                            <option value="" selected disabled>-- Pilih Pemakai --</option>
                                            <?php foreach ($list_pemakai as $p) { ?>
                                                <?php if ($ld->id_pemakai == $p->id_pemakai) { ?>
                                                    <option value="<?= $p->id_pemakai; ?>" selected><?= $p->nama; ?></option>
                                                <?php } else { ?>
                                                    <option value="<?= $p->id_pemakai; ?>"><?= $p->nama; ?></option>
                                                <?php } ?>
                                            <?php } ?>
                                        </select>
                                    </div>
